/* Twelve varied mentors — the illustrative set index.html loads.

   SAMPLE, NOT PRODUCT TRUTH. The names, roles, call counts and ratings are
   review data. The
   ...
   holds for experienceLevel, timeZone, availableInHours and rating. Domain,
   expertise and industry are the only mentor attributes taken verbatim from the
   prototype taxonomy.
